...
void i2c_int_handler(unsigned char *adcbuffer) {
    ...
    if (msg_to_send) {
        ...
        if(ic_ptr->buffer[0] == 0xAA){
            ...
            unsigned char messageType = 0x01, checksum;
            ...
            if (adcbuffer[2] > 0xA5)
                message[2] = 0x01;
            // Very Far
            else if (adcbuffer[2] < 0x55)
                message[2] = 0x04;
            // Far
            else if (adcbuffer[2] < 0x86)
                message[2] = 0x03;
            // In between
            else
                message[2] = 0x02;
            ...
            if (adcbuffer[3] > 0x9D)
                message[3] = 0x01;
            // Very Far
            else if (adcbuffer[3] < 0x50)
                message[3] = 0x04;
            // Far
            else if (adcbuffer[3] < 0x7F)
                message[3] = 0x03;
            // In between
            else
                message[3] = 0x02;
            ...
            message[4] = adcbuffer[7];
            if (adcbuffer[7] == 0x01)
                adcbuffer[7] = 0x00;
            checksum = message[1] + message[2] + message[3] + message[4];
            message[5] = checksum & messageType;
